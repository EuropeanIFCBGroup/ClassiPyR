...
Thank you for your interest in contributing to `ClassiPyR`! This
...
Before submitting a bug report: - Check existing issues to avoid
duplicates - Collect information about the bug (R version, OS, error
messages)

When submitting a bug report, please include: - A clear, descriptive
title - Steps to reproduce the issue - Expected vs actual behavior - R
session info
...
Feature suggestions are welcome! Please: - Check existing issues for
similar suggestions - Describe the feature and its use case - Explain
how it would benefit IFCB researchers
...
Use conventional commit format: - `feat:` new features - `fix:` bug
fixes - `docs:` documentation changes - `test:` test additions or
modifications - `refactor:` code refactoring
...
Tests are located in `tests/testthat/`. When adding new functionality,
