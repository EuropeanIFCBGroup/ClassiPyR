...
5. **Save your work**: Click **Save as .mat** or **Save as .txt** to keep your class list for future sessions

> **Note**: The temporary class list works for the current session, but you should save it to a file for future use.
