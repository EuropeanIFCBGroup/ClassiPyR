...
<img src="https://europeanifcbgroup.github.io/ClassiPyR/reference/figures/class-editor.png" alt="Class list editor for adding, removing, and reordering classes." style="max-width:80%;">
</a>
<p><em>Class list editor for adding, removing, and reordering classes. Click to enlarge.</em></p>
