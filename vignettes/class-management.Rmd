...
<a href="../reference/figures/class-editor.png">
<img src="../reference/figures/class-editor.png" alt="Class list editor for adding, removing, and reordering classes." style="max-width:80%;">
</a>
