...
> **Note**: This section is primarily relevant if you use the [ifcb-analysis](https://github.com/hsosik/ifcb-analysis) MATLAB toolbox (Sosik & Olson, 2007). If you only work with CSV exports, class indices are less critical.
