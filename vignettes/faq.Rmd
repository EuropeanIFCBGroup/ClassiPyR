...
4. Click the **Sync** button (circular arrow icon) to rescan folders if you recently added new data
...
- **Linux**: `~/.local/share/ClassiPyR/file_index.json`
- **macOS**: `~/Library/Application Support/ClassiPyR/file_index.json`
- **Windows**: `%LOCALAPPDATA%/ClassiPyR/file_index.json`
