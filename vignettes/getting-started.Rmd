...
<a href="../reference/figures/settings-dialog.png">
<img src="../reference/figures/settings-dialog.png" alt="Settings dialog showing folder configuration options." style="max-width:80%;">
</a>
...
<a href="../reference/figures/sample-browser.png">
<img src="../reference/figures/sample-browser.png" alt="Sample browser with year/month filters and status indicators." style="max-width:60%;">
</a>
...
<a href="../reference/figures/gallery-view.png">
<img src="../reference/figures/gallery-view.png" alt="Image gallery showing classified plankton images grouped by class." style="max-width:100%;">
</a>
...
<a href="../reference/figures/relabel-workflow.png">
<img src="../reference/figures/relabel-workflow.png" alt="Relabeling workflow: selected images (blue borders) ready to be assigned a new class." style="max-width:100%;">
</a>
